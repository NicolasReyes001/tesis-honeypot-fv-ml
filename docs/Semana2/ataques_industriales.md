...
Desde la perspectiva formal empleada en la literatura de sistemas de potencia, un estimador de estado relaciona un vector de mediciones z con un vector de variables de estado x mediante una función h, de forma que z = h(x) + e, donde e representa el error de medición. La construcción clásica de un FDIA consiste en diseñar un vector de ataque a tal que la medición comprometida z_a = z + a produzca una estimación de estado desplazada de forma controlada, sin que el residuo entre la medición y la estimación supere el umbral utilizado por las pruebas estadísticas de detección de datos erróneos, como la prueba de chi-cuadrado o la prueba del mayor residuo normalizado. Esta propiedad es lo que convierte al FDIA en un ataque particularmente sigiloso: el atacante no solo falsea un valor, sino que lo hace de manera que permanezca matemáticamente indistinguible del ruido de medición normal del sistema.
...
- L., Rajesh, & Satyanarayana, P. (2021). Detection and Blocking of Replay, False Command, and False Access Injection Commands in SCADA Systems with Modbus Protocol. Security and Communication Networks, Hindawi. https://www.hindawi.com/journals/scn/2021/8887666/
...
- Liu, Y., Ning, P., & Reiter, M. K. (2011). False Data Injection Attacks Against State Estimation in Electric Power Grids. ACM Transactions on Information and System Security. Referenciado en: Detecting False Data Injection Attacks in Smart Grids. https://arxiv.org/pdf/2104.06307
