...
¿De qué manera el diseño, implementación e integración de un honeypot industrial de media interacción integrado con simulación matemático-solar y un módulo de Machine Learning permite detectar y clasificar eventos maliciosos dirigidos a sistemas fotovoltaicos y entornos SCADA?
...
La justificación la encontramos que al abrir servicios específicos como lo son los OT y IoT, los ataques dejen de ser ruido genérico y se puedan convertir en eventos con marcas de tiempo, credenciales y comandos específicos del sector eléctrico solar.
...
Como justificación se tiene que los árboles de decisión del algoritmo manejan de forma excelente las fronteras de los datos tabulares cada que un ataque cambia drásticamente los umbrales de la red.
